...
export const a = function CustomLink({ href, children, ...props }) {
  ...
  if (isExternal) {
    return (
      <a
        ...
        className="group relative isolate flex items-center rounded-lg px-2 py-0.5 text-[0.8125rem]/6 font-medium font-display text-white/30 transition-colors hover:text-sky-300"
        {...props}
      >
